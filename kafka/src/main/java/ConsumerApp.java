...
//        props.put("client.id", "");
        ...
        partitions.add(new TopicPartition("ms_topic", 0)); // Adds a TopicPartition instance representing a topic and a partition.
//        partitions.add(new TopicPartition("ms_topic", 2)); // Adds an additional TopicPartition instance representing a different partition within the topic. Change as desired.
